  ...
  >
    <div class="consult-dialog-content">
      <el-form label-width="80px">
        ...
        <!-- 目标列表 -->
        <el-form-item label="选择坐席" required>
...
import { Search, User, Check } from '@element-plus/icons-vue'
...
const filteredTargets = computed(() => {
  let list = props.targets.filter(item => item.type === 'agent')
